...
{
    public partial class frmDSSVDKLTC : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            {
                frm.PrintDSSVDKLTC(cmbKhoa.Text.Trim(), cmbNienKhoa.Text.Trim(), cmbHocKy.Text.Trim(), cmbMaMH.SelectedValue.ToString(), cmbMaMH.Text.Trim(),cmbNhom.Text.Trim());
                frm.ShowDialog();
            }
        }
        ...
        private void frmDSSVDKLTC_Load(object sender, EventArgs e)
        {
